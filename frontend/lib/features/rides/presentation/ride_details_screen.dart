...
import 'package:frontend/features/rides/presentation/widgets/rider_requests_section.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<RideParticipantCubit, RideParticipantState>(
      listener: (context, state) {
        if (state is RideParticipantSuccess) {
          _refreshRide();
          ...
          children: [
            ...
            FutureBuilder<Ride>(
              ...
              builder: (context, snapshot) {
                ...
                final currentStatus = ride.userStatus ?? widget.userStatus ?? "None";
                  ...
                  child: Column(
                    ...
                    children: [
                            ...
                            Expanded(
                              child: joinRideButton(
                                ...
                                onChatPressed: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(builder: (context) => RideChatScreen(rideId: ride.id)),
                                  );
                                },
                      ...
                      if (widget.userStatus == "Organizer") ...[
                        ...
                        Row(
                          children: [
                            const Icon(Icons.person_add_alt_1, color: Colors.deepOrange),
                            const SizedBox(width: 8),
                        ...
                        const SizedBox(height: 10),
                        RiderRequestsSection(rideId: ride.id),
                      ],
                    ],
                  ),
                );
